...
// const dom  = new JSDOM('<!DOCTYPE html><p>Title</title></p>'); //创建一个htm页面
const dom = new JSDOM('',
    {
        url:'https://www.xiaohongshu.com/',  // window.location，document.URL
        // referrer: "https://www.xiaohongshu.com/",  // document.referrer
        // contentType: "text/html",  // document.contentType
        userAgent: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.0.0 Safari/537.36',  // UA
        // includeNodeLocations: true  // 保留由HTML解析器生成的位置信息，允许使用nodeLocation()方法
    } // useagent 默认 Mozilla/5.0 (win32) AppleWebKit/537.36 (KHTML, like Gecko) jsdom/22.1.0
)
window = dom.window;
var document = window.document;
document.cookie = 'a1=1887ef01c15me5jq72omsn3y9dgrdfuik4e03fvxf50000278322; web_session=030037a349cfcb37bed0f3dd02234a4833e13c;';
