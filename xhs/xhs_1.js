...
Object.defineProperties(PerformanceTiming.prototype, {
  navigationStart: {get(){ v_console_log("  [*] PerformanceTiming -> navigationStart[get]", 1685769089604);return 1685769089604 }},
...
Object.defineProperties(HTMLAllCollection.prototype, {
  length: {get(){ v_console_log("  [*] HTMLAllCollection -> length[get]", 252);return 252 }},
  [Symbol.toStringTag]: {value:"HTMLAllCollection",writable:false,enumerable:false,configurable:true},
})
Object.defineProperties(Navigator.prototype, {
  userAgent: {get(){ v_console_log("  [*] Navigator -> userAgent[get]", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.0.0 Safari/537.36");return "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.0.0 Safari/537.36" }},
  ...
  appVersion: {get(){ v_console_log("  [*] Navigator -> appVersion[get]", "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.0.0 Safari/537.36");return "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.0.0 Safari/537.36" }},
...
Object.defineProperties(Image.prototype, {
  src: {get(){ v_console_log("  [*] Image -> src[get]", "https://sns-avatar-qc.xhscdn.com/avatar/625e149d5c6c06b285f501b1.jpg?imageView2/2/w/60/format/webp|imageMogr2/strip");return "https://sns-avatar-qc.xhscdn.com/avatar/625e149d5c6c06b285f501b1.jpg?imageView2/2/w/60/format/webp|imageMogr2/strip" },set(){ v_console_log("  [*] Image -> src[set]", [].slice.call(arguments));return "https://sns-avatar-qc.xhscdn.com/avatar/625e149d5c6c06b285f501b1.jpg?imageView2/2/w/60/format/webp|imageMogr2/strip" }},
...
Object.defineProperties(URL.prototype, {
  ...
  pathname: {get(){ v_console_log("  [*] URL -> pathname[get]", "/explore");return "/explore" },set(){ v_console_log("  [*] URL -> pathname[set]", [].slice.call(arguments));return "/explore" }},
  href: {get(){ v_console_log("  [*] URL -> href[get]", "https://edith.xiaohongshu.com/api/sns/web/v1/homefeed");return "https://edith.xiaohongshu.com/api/sns/web/v1/homefeed" }},
...
Object.defineProperties(PerformanceEntry.prototype, {
  ...
  startTime: {get(){ v_console_log("  [*] PerformanceEntry -> startTime[get]", 1109.3999999761581);return 1109.3999999761581 }},
...
Object.defineProperties(Node.prototype, {
  ...
  textContent: {get(){ v_console_log("  [*] Node -> textContent[get]", "健身");return "健身" },set(){ v_console_log("  [*] Node -> textContent[set]", [].slice.call(arguments));return "健身" }},
...
Object.defineProperties(PerformanceResourceTiming.prototype, {
  ...
  responseStart: {get(){ v_console_log("  [*] PerformanceResourceTiming -> responseStart[get]", 236.0999999642372);return 236.0999999642372 }},
...
Object.defineProperties(LayoutShift.prototype, {
  ...
  value: {get(){ v_console_log("  [*] LayoutShift -> value[get]", 0.0006224338723723864);return 0.0006224338723723864 }},
...
Object.defineProperties(PerformanceEventTiming.prototype, {
  processingStart: {get(){ v_console_log("  [*] PerformanceEventTiming -> processingStart[get]", 5578.800000011921);return 5578.800000011921 }},
...
Object.defineProperties(Element.prototype, {
  ...
  clientHeight: {get(){ v_console_log("  [*] Element -> clientHeight[get]", 216);return 216 }},
  ...
  clientWidth: {get(){ v_console_log("  [*] Element -> clientWidth[get]", 704);return 704 }},
  ...
  scrollTop: {get(){ v_console_log("  [*] Element -> scrollTop[get]", 2300);return 2300 }},
  scrollWidth: {get(){ v_console_log("  [*] Element -> scrollWidth[get]", 704);return 704 }},
...
Object.defineProperties(Document.prototype, {
  ...
  title: {set(){ v_console_log("  [*] Document -> title[set]", [].slice.call(arguments));return "visible" }},
...
Object.defineProperties(HTMLImageElement.prototype, {
  src: {get(){ v_console_log("  [*] HTMLImageElement -> src[get]", "https://sns-avatar-qc.xhscdn.com/avatar/625e149d5c6c06b285f501b1.jpg?imageView2/2/w/60/format/webp|imageMogr2/strip");return "https://sns-avatar-qc.xhscdn.com/avatar/625e149d5c6c06b285f501b1.jpg?imageView2/2/w/60/format/webp|imageMogr2/strip" },set(){ v_console_log("  [*] HTMLImageElement -> src[set]", [].slice.call(arguments));return "https://sns-avatar-qc.xhscdn.com/avatar/625e149d5c6c06b285f501b1.jpg?imageView2/2/w/60/format/webp|imageMogr2/strip" }},
...
Object.defineProperties(HTMLAnchorElement.prototype, {
  href: {get(){ v_console_log("  [*] HTMLAnchorElement -> href[get]", "https://t2.xiaohongshu.com/api/v2/collect");return "https://t2.xiaohongshu.com/api/v2/collect" },set(){ v_console_log("  [*] HTMLAnchorElement -> href[set]", [].slice.call(arguments));return "https://t2.xiaohongshu.com/api/v2/collect" }},
  protocol: {get(){ v_console_log("  [*] HTMLAnchorElement -> protocol[get]", "https:");return "https:" }},
  host: {get(){ v_console_log("  [*] HTMLAnchorElement -> host[get]", "t2.xiaohongshu.com");return "t2.xiaohongshu.com" }},
  search: {get(){ v_console_log("  [*] HTMLAnchorElement -> search[get]", "");return "" }},
  hash: {get(){ v_console_log("  [*] HTMLAnchorElement -> hash[get]", "");return "" }},
  hostname: {get(){ v_console_log("  [*] HTMLAnchorElement -> hostname[get]", "t2.xiaohongshu.com");return "t2.xiaohongshu.com" }},
  port: {get(){ v_console_log("  [*] HTMLAnchorElement -> port[get]", "");return "" }},
  pathname: {get(){ v_console_log("  [*] HTMLAnchorElement -> pathname[get]", "/api/v2/collect");return "/api/v2/collect" }},
  target: {set(){ v_console_log("  [*] HTMLAnchorElement -> target[set]", [].slice.call(arguments));return "/api/v2/collect" }},
...
Object.defineProperties(HTMLLIElement.prototype, {
  value: {get(){ v_console_log("  [*] HTMLLIElement -> value[get]", 0);return 0 },set(){ v_console_log("  [*] HTMLLIElement -> value[set]", [].slice.call(arguments));return 0 }},
  [Symbol.toStringTag]: {value:"HTMLLIElement",writable:false,enumerable:false,configurable:true},
})
Object.defineProperties(HTMLMediaElement.prototype, {
  muted: {get(){ v_console_log("  [*] HTMLMediaElement -> muted[get]", false);return false },set(){ v_console_log("  [*] HTMLMediaElement -> muted[set]", [].slice.call(arguments));return false }},
  src: {set(){ v_console_log("  [*] HTMLMediaElement -> src[set]", [].slice.call(arguments));return false }},
  preload: {set(){ v_console_log("  [*] HTMLMediaElement -> preload[set]", [].slice.call(arguments));return false }},
  autoplay: {set(){ v_console_log("  [*] HTMLMediaElement -> autoplay[set]", [].slice.call(arguments));return false }},
  loop: {get(){ v_console_log("  [*] HTMLMediaElement -> loop[get]", false);return false },set(){ v_console_log("  [*] HTMLMediaElement -> loop[set]", [].slice.call(arguments));return false }},
...
Object.defineProperties(HTMLScriptElement.prototype, {
  ...
  src: {get(){ v_console_log("  [*] HTMLScriptElement -> src[get]", "chrome-extension://doheogeolmnlejjfpdfldnnicofckndc/web_accessible_resources.js");return "chrome-extension://doheogeolmnlejjfpdfldnnicofckndc/web_accessible_resources.js" },set(){ v_console_log("  [*] HTMLScriptElement -> src[set]", [].slice.call(arguments));return "chrome-extension://doheogeolmnlejjfpdfldnnicofckndc/web_accessible_resources.js" }},
...
init_cookie("websectiga=6169c1e84f393779a5f7de7303038f3b47a78e47be716e7bec57ccce17d45f99; sec_poison_id=8df44f01-58bd-442e-96f2-b00bfae449f0; a1=1887faadb29mug83fn3lgtqzhludvrxfure8103gc50000192589; webId=5e47079a2d61c49f287f662c9b5ca5fc; smidV2=20230603131123aeda24990adad930b048470e17823f53004ccfabeb62608f0; gid=yYYWi00fY274yYYWi00fDF8qJj67kYqiIq1kdkS9Aux17Y28fhFCiy888yjJ2Yj8qyDWYJ2j; webBuild=2.8.6; xsecappid=xhs-pc-web; cache_feeds=[]")
...
function v_getele(name, func){
  ...
  if(name == "meta[name=\"head:count\"]" && func == "querySelector"){ return v_new(HTMLMetaElement) }
...
function v_geteles(name, func){
  if(name == "script" && func == "getElementsByTagName"){ return [v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement),v_new(HTMLScriptElement)] }
  if(name == "adsbox" && func == "getElementsByClassName"){ return [] }
  if(name == "body" && func == "getElementsByTagName"){ return [v_new(HTMLBodyElement)] }
  if(name == "link" && func == "getElementsByTagName"){ return [v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement),v_new(HTMLLinkElement)] }
  if(name == "style" && func == "getElementsByTagName"){ return [v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement),v_new(HTMLStyleElement)] }
  return null
}
var v_Date = Date;
    ...
    function Sanji() {
        ...
        return function(_ace_4752e, _ace_aa949, _ace_be07c) {
            ...
            var _ace_8cba0 = function(_ace_0a916) {
                // if (_ace_0a916._ace_47589 == 'RegExp') {
                //     _ace_0a916._ace_936 = window;
                // } else if (_ace_0a916._ace_47589 == 'Array') {
                //     _ace_0a916._ace_936 = window;
                // } else if (_ace_0a916._ace_47589 == 'Function') {
                //     _ace_0a916._ace_936 = window;
                // } else if (_ace_0a916._ace_47589 == 'parseInt') {
                //     _ace_0a916._ace_936 = window;
                // }
...
var params = {"cursor_score":"1.6857568648920078E9","num":27,"refresh_type":3,"note_index":108,"unread_begin_note_id":"","unread_end_note_id":"","unread_note_count":0,"category":"homefeed_recommend","search_key":""};
zsh = window._webmsxyw('/api/sns/web/v1/homefeed', params);

console.log(zsh);
console.log(zsh['X-s'].length);
