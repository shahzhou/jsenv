        ...
        return function(_garp_d3e7c, _garp_d0ad1, _garp_8d381) {
            ...
            var _garp_70118 = function(_garp_d87b) {
                try {
                    ...
                    return _garp_d87b._garp_d16d ? window[_garp_d87b._garp_8b4] : _garp_d87b._garp_7dc41;
                }
            ...
            , function(p0, p1, p2, p3, p4, p5, p6) {
               ...
               try {
                   ...
                   _garp_6ab4(delete window[_garp_7b69a._garp_8b4], _garp_8d381, _garp_8d381, 0);
                }
                return ++p4;
            }
            , function(p0, p1, p2, p3, p4, p5, p6) {
            ...
            , function(p0, p1, p2, p3, p4, p5, p6) {
                var _garp_7b69a = _garp_d66b0(p0, p1)
                  , _garp_a3d40 = _garp_73234(p2, p3);
                   //if (_garp_a3d40 && _garp_a3d40.length<132){console.log(p2,p3,_garp_a3d40)}
                    //if (_garp_a3d40 && _garp_a3d40.length>132){console.log(p2,p3,_garp_a3d40)}
                    ...
                    if (_garp_a3d40 && typeof _garp_a3d40==="object" && _garp_a3d40.hasOwnProperty('signVersion')){
                     ...
                     if (_garp_a3d40 && Array.isArray(_garp_a3d40)){
                           const lastElement = _garp_a3d40[_garp_a3d40.length - 1];
...
function get_xs(api,data,cookie){
    window.document.cookie = cookie
    console.log(888, window.document.cookie)
    var xs = window._webmsxyw(api,data)
    return xs
}

// console.log(get_xs("/api/sns/web/v1/feed",{"source_note_id":"62d4e8a800000000120019dd"},"188392ccdbbk41ajfrbba1ngli7wcccg88o04w12v50000303000"));
...
zsh = get_xs('/api/sns/web/v1/homefeed', params, 'a1=1887ef01c15me5jq72omsn3y9dgrdfuik4e03fvxf50000278322;');
